    ...
    <div class="row">
        <div class="card h-100 col-md-9 mx-auto">
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active"><a href="#">Ujian baru</a></li>
            </ol>
            <div class="card-body">
                   <div class="login-panel panel panel-default">
                       <div class="card-title panel-heading">
                           <h3 class="panel-title">Buat Ujian baru</h3>
                       </div>

                       <div class="card-form panel-body">
                           <form role="form" method="POST" action="{{route('test.store', [$course->id, $lesson->id])}}" enctype="multipart/form-data">
                               <fieldset>
                                   ...
                                   <div class="form-group">
                                        <label for="position"><b>Keterangan :</b></label>
                                        <textarea class="form-control" placeholder="Keterangan" name="description" rows="9" cols="80">{{old('description')}}</textarea>
                                   </div>
                                   {{ csrf_field() }}
