...
class Single_Post_Template_Plugin {
	...
	function add_metabox() {
		...
		if ( $this->get_post_templates() ) {
			add_meta_box( 'pt_post_templates', __( 'Single Post Template', 'belajarcpp' ), array( $this, 'metabox' ), 'post', 'normal', 'high' );
		}
	...
	function metabox( $post ) {
		...
		<label class="hidden" for="post_template"><?php  esc_html_e( 'Post Template', 'belajarcpp' ); ?></label><br />
		<select name="_wp_post_template" id="post_template" class="dropdown">
			<option value=""><?php esc_html_e( 'Default', 'belajarcpp' ); ?></option>
